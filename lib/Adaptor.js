...
function addRow(params) {
  ...
  return function (state) {
    ...
    var _state$configuration = state.configuration,
        name = _state$configuration.name,
        idToken = _state$configuration.idToken,
        picture = _state$configuration.picture,
        sheetUrl = _state$configuration.sheetUrl,
        expiresIn = _state$configuration.expiresIn,
        tokenType = _state$configuration.tokenType,
